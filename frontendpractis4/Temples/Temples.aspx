<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Temples.aspx.cs" Inherits="frontendpractis.Temples.Temples" %>
...
<!-- packages section ends -->
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TourAndTravelConnectionString %>" SelectCommand="SELECT * FROM [Temples]"></asp:SqlDataSource>
