<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Temples_Detail.aspx.cs" Inherits="frontendpractis.Temples.Temples_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                ...
                <div class='col-md-7'id="marginDAY" >
                    ...
                    <table>
                        <tr>
                            ...
                            <td id="span11"></td>
                            <td> 
                                <asp:Image ID="Image7" runat="server" CssClass="KashmirIMG2" ImageUrl='<%# Eval("img_8") %>'/>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TourAndTravelConnectionString2 %>" SelectCommand="SELECT * FROM [Temples] WHERE ([Id] = @Id)">
        <SelectParameters>
