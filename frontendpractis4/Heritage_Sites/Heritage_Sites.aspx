<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Heritage_Sites.aspx.cs" Inherits="frontendpractis.Heritage_Sites.Heritage_Sites" %>
...
<!-- packages section ends -->
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TourAndTravelConnectionString %>" SelectCommand="SELECT * FROM [Heritage_Sites]"></asp:SqlDataSource>
