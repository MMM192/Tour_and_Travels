<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Heritage_Sites_Detail.aspx.cs" Inherits="frontendpractis.Heritage_Sites.Heritage_Sites_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TourAndTravelConnectionString2 %>" SelectCommand="SELECT * FROM [Heritage_Sites] WHERE ([Id] = @Id)">
        <SelectParameters>
