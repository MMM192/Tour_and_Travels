...
{
    public partial class National_Park : System.Web.UI.Page
    {
        ...
        void LoadRecord()
        {
            ...
            SqlCommand cmd = new SqlCommand("select P_name,P_Location_info,Title_of_package from National_Park", con);
        ...
        void LoadRecord1()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from National_Park", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
...
"alert",
"alert('update ..');window.location ='National_Park.aspx';",
true);
