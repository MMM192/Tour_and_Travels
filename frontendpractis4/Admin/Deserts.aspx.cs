...
{
    public partial class Deserts : System.Web.UI.Page
    {
        ...
        void LoadRecord()
        {
            ...
            SqlCommand cmd = new SqlCommand("select P_name,P_Location_info,Title_of_package from Deserts", con);
        ...
        void LoadRecord1()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Deserts", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
...
"alert",
"alert('update ..');window.location ='Deserts.aspx';",
true);
