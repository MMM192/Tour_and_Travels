...
{
    public partial class Heritage_Sites : System.Web.UI.Page
    {
        ...
        void LoadRecord()
        {
            ...
            SqlCommand cmd = new SqlCommand("select P_name,P_Location_info,Title_of_package from Heritage_Sites", con);
        ...
        void LoadRecord1()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Heritage_Sites", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
...
"alert",
"alert('update ..');window.location ='Heritage_Sites.aspx';",
true);
