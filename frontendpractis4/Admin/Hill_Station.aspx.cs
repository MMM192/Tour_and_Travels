...
{
    public partial class Hill_Station : System.Web.UI.Page
    {
        ...
        void LoadRecord()
        {
            ...
            SqlCommand cmd = new SqlCommand("select P_name,P_Location_info,Title_of_package from Hill_Station", con);
        ...
        void LoadRecord1()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Hill_Station", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
...
"alert",
"alert('update ..');window.location ='Beaches.aspx';",
true);
