...
{
    public partial class Beaches1 : System.Web.UI.Page
    {
        ...
        void LoadRecord()
        {
            ...
            SqlCommand cmd = new SqlCommand("select P_name,P_Location_info,Title_of_package from Beaches", con);
        ...
        void LoadRecord1()
        {
            ...
            SqlCommand cmd = new SqlCommand("select * from Beaches", con);
            SqlDataAdapter da = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            da.Fill(dt);
