<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="National_Park_Detail.aspx.cs" Inherits="frontendpractis.National_Park.National_Park_Detail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TourAndTravelConnectionString2 %>" SelectCommand="SELECT * FROM [National_Park] WHERE ([Id] = @Id)">
        <SelectParameters>
