<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="National_Park.aspx.cs" Inherits="frontendpractis.National_Park.National_Park" %>
...
<!-- packages section ends -->
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TourAndTravelConnectionString %>" SelectCommand="SELECT * FROM [National_Park]"></asp:SqlDataSource>
