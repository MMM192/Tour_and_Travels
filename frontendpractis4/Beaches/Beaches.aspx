<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Beaches.aspx.cs" Inherits="frontendpractis.Dynamic.Beaches" %>
...
<!-- packages section ends -->
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:TourAndTravelConnectionString %>" SelectCommand="SELECT * FROM [Beaches]"></asp:SqlDataSource>
